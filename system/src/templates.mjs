...
export default async function preloadHandlebarsTemplates() {
	const partials = [
		"systems/fallout/templates/actor/_shared_partials/npc_body.hbs",
		...
		"systems/fallout/templates/item/perk/description-tab.hbs",
		"systems/fallout/templates/item/perk/requirements-tab.hbs",
		"systems/fallout/templates/item/perk/attributes.hbs",
